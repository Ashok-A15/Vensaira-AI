...
const TECHS = [
  {
    ...
    text: 'Build intelligent systems that learn from data and continuously improve.',
  },
  {
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /><polyline points="3.27 6.96 12 12.01 20.73 6.96" /><line x1="12" y1="22.08" x2="12" y2="12" /></svg>,
    title: 'Generative AI',
    text: 'Create next-generation applications powered by generative models.',
  },
  {
    ...
    title: 'LLMs',
    text: 'Build intelligent applications around powerful language models.',
  },
  {
    ...
    title: 'Agentic AI',
    text: 'Develop autonomous AI agents capable of reasoning, planning, and taking action.',
  },
  {
    ...
    text: 'Create natural and intelligent interactions between people and technology.',
  },
  {
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20" /><path d="M2 12h20" /></svg>,
    title: 'Quantum AI',
    text: 'Explore emerging quantum-enhanced approaches to machine learning.',
  },
  {
    ...
    text: 'Transform learning through personalization, automation, and intelligent assistance.',
  },
];

export default function TechnologyFocus() {
  return (
    <section className="section" id="technology" style={{ paddingTop: 0 }} aria-labelledby="tech-title">
      <div className="container">
        <div className="section-header">
          <h2 className="section-title gradient-text" id="tech-title">Our AI Technology Focus</h2>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 24 }}>
          {TECHS.map((t) => (
            <div className="value-card" key={t.title}>
              <div className="value-icon" aria-hidden="true">{t.icon}</div>
              <h3 className="value-title">{t.title}</h3>
              <p className="value-text">{t.text}</p>
            </div>
          ))}
        </div>
      </div>
